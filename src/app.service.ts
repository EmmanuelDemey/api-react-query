...
export class AppService {
  getPerson(id: string): Person {
    return people.find((p) => p.url === `https://swapi.dev/api/people/${id}/`);
  }
  getPeople(page: number = 1): Person[] {
    return people.slice(10 * (page - 1), 10 * (page - 1) + 10);
  }
  updatePeople(id: string, person: Person): Person {
